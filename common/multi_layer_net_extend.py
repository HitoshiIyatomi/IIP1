# multi_laye_net_extend.py
# extented version of multi_layer_net
#
import sys, os
...
class MultiLayerNetExtend:
    """ [extended] fully connected conventional back-propagation neural networks
    [new features]
    (1) Weiht Decay [L2-regularrizer]
    (2) Dropout 
    ...
    use_dropout:  Use of Dropout (True / False)
    dropout_ratio : ratio of Dropout
    use_batchNorm: Use of Batch Normalization (True / False)
    """
